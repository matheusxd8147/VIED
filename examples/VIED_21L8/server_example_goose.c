...
main(int argc, char** argv)
{
    ...
    GooseSubscriber subscriber4 = GooseSubscriber_create("VIED_21L9CFG/LLN0$GO$GOOSE_SH", NULL); //Especificação de quem o ied irá receber as mensagens goose

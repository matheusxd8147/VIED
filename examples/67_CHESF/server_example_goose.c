...
double an[6], ar[6], br[6], teta, torque;
double complex yr[6], Vbc, aVbc, mVbc;
...
{   
    ...
    {   
        ...
        teta = an[3] - aVbc;
        torque = max_corrente_a*mVbc*cos((30 - teta)*pi/180);
        ...
        if(torque > 0){
            ...
            if ((t>0)&&(corrente_primarioA>(pick_up*50/100))){
                    ...
                    if ((time_diff)>=t){
                        printf("-------------------------------------------------------------------------------------------------------------\n");            
                        printf("                       ATUAR FUNÇÃO 67: DIRECIONAL DE SOBRECORRENTE TEMPORIZADA DE FASE                      \n");
                        printf("-------------------------------------------------------------------------------------------------------------\n");

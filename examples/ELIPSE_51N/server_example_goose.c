...
float an[8], teta[6], tetaN, torqueN;
...
{   
    ...
    {   
        ...
        if ((corrente_primarioN)<(pick_up*10/100)){
            ...
            IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_ANN_SVGGIO3_Ind13_stVal, false);
        ...
        if(contadorSV3 == 60){
            ...
            IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_MET_METMMXU1_A_neut_cVal_mag_f, corrente_primarioN);
            ...
            IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_MET_METMMXU1_PhV_res_cVal_mag_f, tensao_primarioN);
            ...
            IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_MET_METMMXU1_A_neut_cVal_ang_f, an[6]);
            ...
            IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_MET_METMMXU1_PhV_res_cVal_ang_f, an[7]);
            contadorSV3 = 0;
            contadorSV3 = 0;
        }

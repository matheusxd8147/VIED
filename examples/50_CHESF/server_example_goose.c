...
svUpdateListener (SVSubscriber subscriber, void* parameter, SVSubscriber_ASDU asdu)
{
    ...
    if (contadorSV1==80)
    {
        ...
        printf("-----------------------------------------------------\n");  
        printf("   Ãngulo: %.2d [V]\n", SVSubscriber_ASDU_getINT32 (asdu, 4) );
        printf("   Ãngulo: %.2d [V]\n", SVSubscriber_ASDU_getINT32 (asdu, 12) );
        printf("   Ãngulo: %.2d [V]\n", SVSubscriber_ASDU_getINT32 (asdu, 20) );
        printf("-----------------------------------------------------\n");
        printf("-----------------------------------------------------\n");  
        printf("   A tensão RMS da fase A no primário é: %.2f [kV]\n", tensao_primarioA/1000 );
        printf("   A tensão RMS da fase B no primário é: %.2f [kV]\n", tensao_primarioB/1000 );
        printf("   A tensão RMS da fase C no primário é: %.2f [kV]\n", tensao_primarioC/1000 );
        printf("-----------------------------------------------------\n");

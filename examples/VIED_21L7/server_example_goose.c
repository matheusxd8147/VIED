...
main(int argc, char** argv)
{
    ...
    while (running) {
        ...
        //IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_ANN_MVGGIO12_AnIn07_mag_f, sqrt(3)*tensao_primarioA*corrente_primarioA);

...
main(int argc, char** argv)
{
    ...
    GooseSubscriber subscriber = GooseSubscriber_create("VIED_21L1CFG/LLN0$GO$GOOSE_STATUS", NULL); //Especificação de quem o ied irá receber as mensagens goose
    GooseSubscriber subscriber1 = GooseSubscriber_create("VIED_21L1CFG/LLN0$GO$GOOSE_POWER", NULL); //Especificação de quem o ied irá receber as mensagens goose
    GooseSubscriber subscriber2 = GooseSubscriber_create("VIED_21L1CFG/LLN0$GO$GOOSE_SH", NULL); //Especificação de quem o ied irá receber as mensagens goose
    GooseSubscriber subscriber3 = GooseSubscriber_create("MUBinIO_BinaryInputs/LLN0$GO$VMU_09_GOOSE", NULL); //Especificação de quem o ied irá receber as mensagens goose
    ...
    while (running) {
        ...
        IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_ANN_MVGGIO12_AnIn09_mag_f, corrente_primarioA);

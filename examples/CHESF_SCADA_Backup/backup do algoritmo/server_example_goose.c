...
{   
    ...
    {   
        ...
        //IedServer_updateCtlModel(iedServer, IEDMODEL_CON_RBGGIO1_SPCSO01, CONTROL_MODEL_DIRECT_NORMAL);


        //comando = IedServer_getFloatAttributeValue(iedServer, IEDMODEL_PRO_BKR1CSWI1_Pos_Oper_ctlVal);
        //comando = IedServer_getFloatAttributeValue(iedServer, IEDMODEL_CON_RBGGIO1_SPCSO01_Oper_ctlVal);


        /*if(IedServer_getBooleanAttributeValue(iedServer, IEDMODEL_PRO_BKR1CSWI1_Pos_Oper_ctlVal)==true){
        ...
        //IEDMODEL_PRO_BKR1CSWI1_Pos_Oper_ctlVal
        ...
        if ((t1>0)&&(corrente_primarioB>(pick_up*50/100))){
                ...
                if ((time_diff1)>=t1){
                    ...
                    printf("                         ATUAR FUNÇÃO 51V: SOBRECORRENTE TEMPORIZADA COM RESTRIÇÃO DE TENSÃO                 \n");
                    printf("-------------------------------------------------------------------------------------------------------------\n");
                    IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_PRO_P2TPIOC2_Op_general, true);
        ...
        if ((t2>0)&&(corrente_primarioC>(pick_up*50/100))){
                ...
                if ((time_diff2)>=t2){
                    ...
                    printf("                         ATUAR FUNÇÃO 51V: SOBRECORRENTE TEMPORIZADA COM RESTRIÇÃO DE TENSÃO                 \n");
                    printf("-------------------------------------------------------------------------------------------------------------\n");
                    IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_PRO_P3TPIOC3_Op_general, true);
        ...
        if ((corrente_primarioA<(pick_up*10/100))&&(corrente_primarioB<(pick_up*10/100))&&(corrente_primarioC<(pick_up*10/100))){
                ...
                IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_PRO_P1TPIOC1_Op_general, false);
                IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_PRO_P2TPIOC2_Op_general, false);
                IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_PRO_P3TPIOC3_Op_general, false);

...
{   
    ...
    {   
        ...
        /*IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_PRO_BKR1CSWI1_Pos_Oper_ctlVal, false);*/
        //comando = IedServer_getBooleanAttributeValue(iedServer, IEDMODEL_PRO_BKR1CSWI1_Pos_Oper_ctlVal);

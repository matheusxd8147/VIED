...
main(int argc, char** argv)
{
    ...
    GooseSubscriber subscriber2 = GooseSubscriber_create("MUBinIO_BinaryInputs/LLN0$GO$VMU_02_GOOSE", NULL); //Especificação de quem o ied irá receber as mensagens goose

...
setupSVPublisher(const char* svInterface)
{
    ...
    if (svPublisher) {
        ...
        asdu = SVPublisher_addASDU(svPublisher, "VMU06", NULL, 1);
...
main(int argc, char** argv)
{
    ...
    GooseSubscriber subscriber = GooseSubscriber_create("VIED_21L6CFG/LLN0$GO$CONTROL_BK", NULL); //Especificação de quem o ied irá receber as mensagens goose

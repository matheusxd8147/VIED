...
{   
    ...
    if(resposta == true){
        system ("clear");
        printf("Parametrização de Função 51 ou 51V\n");
    ...
    {   
        ...
        if ((corrente_primarioA<(pick_up*10/100))&&(corrente_primarioB<(pick_up*10/100))&&(corrente_primarioC<(pick_up*10/100))){
                ...
                if(funcao == 1){
                    ...
                    IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_ANN_SVGGIO3_Ind20_stVal, false);
                    IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_ANN_SVGGIO3_Ind21_stVal, false);
                    IedServer_updateBooleanAttributeValue(iedServer, IEDMODEL_ANN_SVGGIO3_Ind22_stVal, false);
                }else{
...
main(int argc, char** argv)
{
    ...
    GooseSubscriber subscriber = GooseSubscriber_create("MUBinIO_BinaryInputs/LLN0$GO$Control_DataSet", NULL); 
